...
export default class Items extends React.Component {
  constructor(props) {
    ...
    localStorage.getItem("state")
      ? (loc = localStorage.getItem("state"))
      : (loc = "MO");
    if (localStorage.getItem("state") === "US") {
      loc = "MO";
    }
          ...
          {this.state.done && (
            <div>
              ...
              <ResultContainer
                ...
                className={this.state.done ? "d-block" : "d-none"}
              />
            </div>
          )}
          <br />
          ...
          {this.state.done && (
            <div>
              <h3>
                ...
                Near you ({localStorage.getItem("state")})
              </h3>
              <hr />
              <ResultContainer
                size={4}
                items={this.state.resultNear}
                className={this.state.done ? "d-block" : "d-none"}
              />
            </div>
          )}
