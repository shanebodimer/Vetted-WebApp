...
This project was created to kickstart all future projects that will use React. It contains commonly used packages, structures, and files that aren't part of the boostrapped project.
...
The following is from the bootstrapped project:
